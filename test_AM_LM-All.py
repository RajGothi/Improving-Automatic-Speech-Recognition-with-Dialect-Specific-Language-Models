...
def compute_metrics(pred):
    ...
    label_str = processor.decode(pred.label_ids, group_tokens=False)
...
if __name__ == "__main__":
    ...
    lm_repo_name = config['LM_repo_name']
    am_repo_name = config['AM_repo_name']
    ...
    processor = Wav2Vec2ProcessorWithLM.from_pretrained(lm_repo_name)
    model = Wav2Vec2ForCTC.from_pretrained(am_repo_name)
    processor_decode = Wav2Vec2Processor.from_pretrained(am_repo_name)
